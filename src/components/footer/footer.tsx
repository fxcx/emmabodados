        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-start justify-between gap-12">
          ...
          <div className="flex">
            <ImageUtils
              ...
              className="w-28 md:w-40 lg:w-60 p-4"
            />
          </div>
          <div className="flex-1 max-w-md order-3 lg:order-2 text-center lg:text-left p-6">
          ...
          <div className="flex-1 max-w-md order-2 lg:order-3 text-center lg:text-left p-6">
